...
public class PersistentObjectTest {
	...
	public void existsWorks() {
		...
		boolean exists = this.persistentObject.exists(sId, Persona1.class);

		assertFalse(exists);

		assertDoesNotThrow(() -> this.persistentObject.store(sId, new Persona1()));

		exists = this.persistentObject.exists(sId, Persona1.class);
